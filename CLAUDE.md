...
## Design Reference
- **Prototype**: `/FitYear UX Recommendations.html` — open in browser to see every screen
- **Implementation spec**: `/README.md` — full feature specs, DB schema, API endpoints, prompts
